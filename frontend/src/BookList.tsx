    ...
    return (
        <>
            ...
            {!showCartPage ? (
                <>
                    ...
                    {Object.keys(cart).length > 0 && (
                        <div className="alert alert-secondary d-flex justify-content-between align-items-center">
                            <div>
                                <strong>Cart Summary:</strong> {Object.values(cart).reduce((sum, item) => sum + item.quantity, 0)} item(s), Total: ${total.toFixed(2)}
                            </div>
                            <button className="btn btn-sm btn-outline-primary" onClick={() => setShowCartPage(true)}>
                                View Cart
                            </button>
                        </div>
                    )}
                ...
                <>
                    <h1>Cart Summary</h1>
                    <button className="btn btn-primary mb-3" onClick={() => setShowCartPage(false)}>
                        Continue Shopping
                    </button>
                    <div className="alert alert-info">
                        {Object.keys(cart).length > 0 ? (
